...
| متغیرها       |            کاربرد            |
|----------------:|-----------------------------:|
| `TELEGRAM_API_TOKEN`  8289085516:AAHRWLkJoxmGqJM8S3pdThtPY09JzuQqHho         | توکن ربات تلگرام|       
...
| `TELEGRAM_LOGGER_CHANNEL_ID` |8706836237 آیدی عددی کانال برای لاگ‌های پنل در صورت تمایل        |  
